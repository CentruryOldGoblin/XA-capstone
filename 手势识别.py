  ...
  while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        for handLms in results.multi_hand_landmarks:
            ...
            x1=handLms.landmark[0].x-z1
            y1=handLms.landmark[0].y-z1
            z2=handLms.landmark[12].z
            x2=handLms.landmark[12].x-z2
            y2=handLms.landmark[12].y-z2
            
            tai = math.sqrt(dis(x1,y1,x2,y2)**2+(z1-z2)**2)
            print("a hand")
            print(z1-z2)
            print(x1-x2)
            print(y1-y2)
